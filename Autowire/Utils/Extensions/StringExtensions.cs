...
namespace Autowire.Utils.Extensions
{
	...
	public static class StringExtensions
	{
		...
		/// <summary>Gets or sets the invariant culture.</summary>
		public static IFormatProvider InvariantCulture { get; set; }
		...
		/// <summary>Replaces one or more format items in a specified string with the string representation of a specified object by using <see cref="InvariantCulture"/>.</summary>
		...
		{
			return string.Format( InvariantCulture, format, arg0 );
		}

		/// <summary>Replaces the format items in a specified string with the string representations of two specified objects by using <see cref="InvariantCulture"/>.</summary>
		/// <param name="format">A composite format string</param>
		...
		{
			return string.Format( InvariantCulture, format, arg0, arg1 );
		}

		/// <summary>Replaces the format items in a specified string with the string representations of three specified objects by using <see cref="InvariantCulture"/>.</summary>
		/// <param name="format">A composite format string</param>
		/// <param name="arg0">The first object to format.</param>
		/// <param name="arg1">The second object to format.</param>
		...
		{
			return string.Format( InvariantCulture, format, arg0, arg1, arg2 );
		}

		/// <summary>Replaces the format item in a specified string with the string representation of a corresponding object in a specified array by using <see cref="InvariantCulture"/>.</summary>
		/// <param name="format">A composite format string</param>
		/// <param name="args">An object array that contains zero or more objects to format.</param>
		/// <returns>A copy of format in which the format items have been replaced by the string representation of the corresponding objects in args.</returns>
		public static string FormatInvariant( this string format, params object[] args )
		{
			return string.Format( InvariantCulture, format, args );
		}
		#endregion
